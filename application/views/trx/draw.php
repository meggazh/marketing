                                ...
                                <div class="box-body">
                                   ...
                                   <div class="row">
                                        <div class="col-md-4 col-md-offset-1">
                                            ...
                                            <label>Kode</label>
                                            <input type="text" class="form-control master-brg" name="TxnDrawHdrNo" placeholder="Kode"> 
								   ...
								   <div class="col-md-4 col-md-offset-2">
                                            ...
                                            <input type="text" class="form-control" name="TxnDrawHdrStatus">
                                            </div><!-- /.input group -->
                                            </div>
                                        </div>
                                   </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr><input type="hidden" id="id-barang" />
                                                ...
                                                <td width="20%"><div class="form-group"><input type="text" id="harga" class="form-control detail-beli" placeholder="Harga" ></td>
                                                <td width="30%"><div class="form-group"><input type="text" id="sub-total" class="form-control detail-beli" placeholder="SubTotal" ></td>
                                            </tr>
                                        </tbody>  
                                    </table> 
