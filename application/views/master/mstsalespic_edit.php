		...
		<fieldset>
			...
			<form method="POST" action="<?php echo site_url('mstsalespic/proses_edit'); ?>">
				<?php foreach($daftar->result() as $a):?>
					<input type="hidden" name="MstSalesPICID" value="<?php echo $a->MstSalesPICID; ?>"/>
					<input type="text" name="MstSalesPICName" value="<?php echo $a->MstSalesPICName; ?>"/>
					<input type="text" name="MstSalesPICPICEmail1" value="<?php echo $a->MstSalesPICPICEmail1; ?>"/>
					<input type="text" name="MstSalesPICPICEmail2" value="<?php echo $a->MstSalesPICPICEmail2; ?>"/>
					<input type="text" name="MstSalesPICPICEmail3" value="<?php echo $a->MstSalesPICPICEmail3; ?>"/>
