 ...
 <head>
	...
	<body>
		...
		<fieldset>
			...
			<form method="POST" action="<?php echo site_url('mstsatuan/proses_edit'); ?>">
				<?php foreach($daftar->result() as $a):?>
					<input type="hidden" name="MstSatID" value="<?php echo $a->MstSatID; ?>"/>
					<input type="text" name="MstSatName" value="<?php echo $a->MstSatName; ?>"/>
					<input type="text" name="MstSatAbbr" value="<?php echo $a->MstSatAbbr; ?>"/>
