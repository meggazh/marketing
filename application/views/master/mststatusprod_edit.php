		...
		<fieldset>
			...
			<form method="POST" action="<?php echo site_url('mststatusprod/proses_edit'); ?>">
				<?php foreach($daftar->result() as $a):?>
					<input type="hidden" name="idMstStatusProd" value="<?php echo $a->idMstStatusProd; ?>"/>
					<input type="text" name="MstStatusProdGroup" value="<?php echo $a->MstStatusProdGroup; ?>"/>
					<input type="text" name="MstStatusProdSubGroup" value="<?php echo $a->MstStatusProdSubGroup; ?>"/>
					<input type="text" name="MstStatusProdJob" value="<?php echo $a->MstStatusProdJob; ?>"/>
